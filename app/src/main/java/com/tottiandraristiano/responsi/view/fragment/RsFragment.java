package com.tottiandraristiano.responsi.view.fragment;
...
import com.tottiandraristiano.responsi.R;
import com.tottiandraristiano.responsi.adapter.RsAdapter;
import com.tottiandraristiano.responsi.model.rs.RsDataItem;
import com.tottiandraristiano.responsi.view.viewmodel.RsViewModel;
...
public class RsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.fragmentrs_rv);
    ...
    private Observer<ArrayList<RsDataItem>> getRsDataItem = new Observer<ArrayList<RsDataItem>>() {
        @Override
